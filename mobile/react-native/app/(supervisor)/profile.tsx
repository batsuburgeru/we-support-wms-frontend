...
const Profile = () => {
    ...
    const fetchUserName = async () => {
        try {
            const response = await fetch("http://192.168.68.104:3002/users/display-user-info", {
                method: "GET",
    ...
    const fetchRequests = async () => {
        try {
            const response = await fetch("http://192.168.68.104:3002/purchaseRequests/view-purchase-requests", {
                method: "GET",
                headers: { "Content-Type": "application/json" },
                credentials: "include",
            });
    ...
    const handleSignOut = async () => {
        try {
            const response = await fetch("http://192.168.68.104:3002/users/logout", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                credentials: "include",
            });
